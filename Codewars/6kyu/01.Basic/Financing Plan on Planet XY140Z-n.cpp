// https://www.codewars.com/kata/559ce00b70041bc7b600013d/train/cpp
...
class Finance
{
    ...
    static unsigned long long finance(unsigned long long n) {
        ...
        for (int weeks = 0; weeks <= n; weeks++)
        {
            unsigned long long counter = weeks * 2;
            for (int days = weeks; days <= n; days++)
            {
                res += counter++;
            }
        }
...
int main() {
    ...
    cout << Finance::finance(5) << endl;   // 105
    cout << Finance::finance(6) << endl;   // 168
    cout << Finance::finance(7) << endl;   // 252
    cout << Finance::finance(8) << endl;   // 360
    cout << Finance::finance(15) << endl;  // 2040
